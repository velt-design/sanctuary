...
import type { AccessoryRates } from '../accessoryRates';
...
import manifestJson from '../config/costing_manifest_v2.7_2026-09-11.json';
...
export const ACTIVE_COSTING_MANIFEST_PATH = 'packages/costing/src/config/costing_manifest_v2.7_2026-09-11.json' as const;
...
const EXPECTED_FILES = {
  ...
  materials_additions: 'materials/sanctuary_materials_additions_v2_2026-09-11.json',
  powdercoat_additions: 'materials/sanctuary_powdercoat_additions_v1_2026-08-11.json',
  hardware_placeholders: 'hardware/hardware_placeholders_v1.json',
  install_actions: 'install_actions_v1.9_2026-08-05.json',
...
export function loadCostingConfigV1(): CostingConfigV1 {
  ...
  return {
    ...
    commercialPolicy: commercialPolicyJson,
  };
}
