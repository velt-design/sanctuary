...
accept an optional keyed afterSummary slot so mobile actions remain available in
loading, unavailable and tailored-price states; desktop has no slot. Existing
