...
Recreated on current main on 2026-08-27 by
`eng_20260827_configurator_pr4_v2`, preserving the audited PR 72 behavior while
resolving its documentation conflict with newer engineering-history entries.
