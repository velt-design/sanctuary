...
| 2026-08-10 | Commercial Record Retirement     | Promoted | Scope payment metrics to the current accepted quote version. Keep older invoices historical, void open invoices with evidence instead of deleting them, permit permanent deletion only for an unsent current draft, and let admins manually retire sent or accepted versions as superseded without erasing their evidence. |
