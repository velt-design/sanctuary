...
function getFirstModule(inputs: CalculatorInputs | LegacyCalculatorInputsV1): CalculatorModuleInputs | null {
  ...
  if (isLegacyCalculatorInputsV1(inputs)) {
    return {
      ...
      powdercoatStandardColour: inputs.powdercoatStandardColour,
      powdercoatIsCustom: inputs.powdercoatIsCustom,
      powdercoatCustomColour: inputs.powdercoatCustomColour,
