...
At 640px and below, `/projects` exposes its collection H1 while detail routes add a compact, tappable return breadcrumb. The project selector remains a focus-managed modal sheet with reversible body scroll locking, Escape handling and focus restoration. Case-study heroes use a 4:3 frame, gallery cards use a consistent 4:3 crop, related projects become compact horizontal cards, and the introductory and final enquiry actions remain visible.
