...
| `calculator-ui-ux-review.md` | Current evidence review | You are planning Calculator responsive, accessibility, hierarchy, density, language, Save, or handoff refinements after the trust work. |
