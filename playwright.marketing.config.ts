...
export default defineConfig({
  testDir: './playwright',
  testMatch: /marketing\.(?:clarity|configurator-lighting|configurator-roof-battens|configurator-sides|configurator-blinds|configurator-roof|configurator-journey|configurator-sharing|configurator-project|configurator-workspace|configurator-preview|configurator-gable|configurator-box|configurator-surroundings|configurator-details|consent|contact|foundation|acrylic-foundation|acrylic-copy-variant|guide-cluster-final-refinement|guide-hub|hero-navigation|home-guided|home-project-finder|homepage|mobile-content-density|phase-(?:three|four|five)|products|projects(?:-phase-two|-switching)?|seo-copy-hygiene|seo-landing|seo-programme|shared-header|simple-cover-calculator|simple-pergolas|touch-motion)\.spec\.ts/,
  timeout: 90_000,
