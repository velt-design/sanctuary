...
beforeEach(() => { vi.clearAllMocks(); mocks.auth.mockResolvedValue({ok:true,session:{user:{email:'jordan@sanctuarypergolas.co.nz',email_confirmed_at:'2026-01-01'}},supabase:{rpc:mocks.rpc}}); mocks.rpc.mockResolvedValue({ data:fixtureReport,error:null }); });
