...
- Site Visits is hidden from normal navigation and V2 work never links to it. The optional `SITE_VISIT_COMPLETED` confirmation is a manual fact with no task, stage, or Schedule side effect.
...
- `ProjectWorkControls` owns V2 manual-work, operational-state, confirmation-correction, and manual hidden Site Visit fact presentation without adding a Site Visit task, normal navigation, or Schedule integration.
