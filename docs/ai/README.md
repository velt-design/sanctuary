...
- Autonomous Engineering Foundation: active. The first slice adds strict provider-neutral engineering task and completion contracts plus deterministic task validation and worker-prompt rendering. Runtime isolation, named supervisor/worker profiles, recovery, CI handoff and rehearsals remain ordered follow-up slices.
