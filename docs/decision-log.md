...
Why it mattered: Repetition weakened the single next action, browser explanation and stage inference blurred server/specialist authority, and duplicate recovery made one unavailable read look like two independent failures.
