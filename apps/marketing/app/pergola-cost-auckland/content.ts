...
export const pergolaCostConfig = {
  ...
  blocks: [
    ...
    { kind: 'projects', id: 'cost-projects', eyebrow: 'Similar labels, different scopes', title: 'Project photography reveals what an area figure leaves out', intro: 'These projects are not price examples. They show why geometry, materials and integrated work need to be understood before a number is compared.', items: [
      { slug: 'st-heliers-townhouse', label: 'Compact gable with custom end framing', summary: 'A 6.0 by 3.0 metre gable uses opal acrylic roofing and a bespoke aluminium pattern where street-facing appearance is part of the scope.', facts: ['18 m² covered area', 'Custom gable-end pattern'] },
      { slug: 'warkworth-outdoor-room', label: 'Complete freestanding outdoor room', summary: 'A 5.0 by 6.0 metre gable brings together structure, mixed roofing, cedar lining, a new deck, fireplace and lighting.', facts: ['30 m² structure', 'Roof, deck and interior elements coordinated'] },
      { slug: 'ardmore-box-carport', label: 'Wide box-perimeter carport', summary: 'Across 54.3 square metres, steel beams, aluminium rafters, acrylic roofing, internal gable geometry and lighting serve a vehicle-cover brief.', facts: ['8.77 x 6.19 m footprint', 'Mixed structural materials'] },
      { slug: 'goodhome-commercial-terrace', label: 'Commercial courtyard coordination', summary: 'A 67.7 square metre, two-zone gable follows the existing architecture across a hospitality setting with commercial coordination needs.', facts: ['10.09 x 6.7 m footprint', 'Existing 25 degree roof relationship'] },
    ] },
    ...
    { kind: 'process', id: 'cost-process', eyebrow: 'Four levels of price confidence', title: 'Let the number become more precise as the evidence improves', intro: 'Each stage should replace an assumption with site, design or scope evidence.', items: [
      { title: 'Pricing context', copy: 'Suburb, photos, rough dimensions, intended use and access concerns establish whether an early discussion can be useful.' },
      { title: 'Initial assessment', copy: 'Likely scope, major material decisions, missing evidence and visible assumptions are recorded before a number is treated as meaningful.' },
      { title: 'Developed project scope', copy: 'Connections, structure, roof form, drainage, access, integrations and project-specific approval responsibilities are assessed together.' },
      { title: 'Comparable quotation', copy: 'Dimensions, materials, inclusions, exclusions, options, GST treatment and responsibilities are documented on the same basis.' },
    ] },
  ...
  mobileDisclosureGroups: [
    { id: 'cost-estimate-detail', summary: 'What makes an early estimate useful', blockIds: ['estimate-quality'] },
    { id: 'cost-scope-support', summary: 'Detailed quote scope and common cost questions', blockIds: ['cost-checklist', 'pergola-cost-faq'] },
  ],
  ...
  form: { ariaLabel: 'Pergola cost enquiry form', eyebrow: 'Price the actual project', heading: 'Request a scoped first look', intro: 'Share the site, rough dimensions and intended use. Sanctuary can then assess the likely scope and explain what still needs confirmation before a final quotation.', submitLabel: 'Request a scoped first look', messageLabel: 'Scope for the first price review', messagePlaceholder: 'Describe the finished outcome you want, including structure, roof, edges, services and any known exclusions or existing work.', briefFields: [
