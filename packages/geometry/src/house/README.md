...
| `roofEaveGraphHipped.ts` | Fully hipped custom orthogonal topology: `buildEaveGraphJoinedHippedRoof`, source-edge envelope/coverage candidate selection, semantic QA gating for unbacked boundaries/chords, duplicate faces, internal eave-height seams, and feature adjacency. Legacy candidates are diagnostic until they prove this semantic gate. | ✅ shipped |
