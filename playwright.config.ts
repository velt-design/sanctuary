...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      name: 'portal-fixture',
      testMatch:
        /portal\.(ai-activity-fixture|command-centre|commercial-workflow-fixture|design-booklet-workbench|drawing-workbench|email-preview-workbench|invoice-artifact-preview-fixture|invoice-draft-editor-fixture|project-journey-actions|project-work-queue-fixture|schedule-board-confidence-fixture|workbench-snapshot|workbench-fixture|workbench-performance|project-mutation-performance)\.spec\.ts/,
      use: {
        ...devices['Desktop Chrome'],
