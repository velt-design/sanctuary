...
import { buildDarkPreparationRecord } from "../scripts/ai/mac-openclaw-dark-install.mjs";
...
describe("OpenClaw dark configuration", () => {
  ...
  it("records the rebuildable recovery mode without pretending activation passed", () => {
