...
describe('buildHouseFormGeometryInput', () => {
  it('builds independent geometry input for each house form id', () => {
    ...
    const houseOne = buildHouseFormGeometryInput({ projectModel, houseFormId: 'house-main' });
    const houseTwo = buildHouseFormGeometryInput({ projectModel, houseFormId: 'house-form-2' });
