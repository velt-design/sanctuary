...
import manifestJson from '../config/costing_manifest_v2.8_2026-09-15.json';
...
export const ACTIVE_COSTING_MANIFEST_PATH = 'packages/costing/src/config/costing_manifest_v2.8_2026-09-15.json' as const;
