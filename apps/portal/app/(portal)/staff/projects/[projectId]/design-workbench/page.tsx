...
import { loadDesignWorkbenchPageData } from '@/lib/drawings/loadDesignWorkbenchPageData';
...
export default async function DesignWorkbenchPage({
  ...
  const context = await loadDesignWorkbenchPageData({
