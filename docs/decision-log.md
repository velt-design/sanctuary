...
Related docs/tests: `apps/portal/app/staff/projects/projectsIndexMutations.test.ts`; `apps/portal/app/staff/projects/ProjectsIndexClient.test.tsx`; `apps/portal/lib/queries/projectCache.test.ts`
