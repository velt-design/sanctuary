...
export default function ConfiguratorRail({
  ...
  const footprintBody = showPlanContextControls ? <div className={styles.fieldStack}>
    ...
    {renderField({ id: 'house-footprint-width', kind: 'number', label: 'House width (m)', value: footprintParams.widthM, helperText: 'Blank matches the pergola length.', pending: pendingFieldId === 'house-footprint-width', error: fieldErrors['house-footprint-width'], disabled: !showPlanContextControls, onCommit: (value) => commitFootprintEdit('house-footprint-width', { type: 'param', key: 'widthM', value }) })}
    {renderField({ id: 'house-footprint-offset-x', kind: 'number', label: 'House offset X (m)', value: footprintParams.offsetXM, helperText: 'Negative values extend left of the pergola.', pending: pendingFieldId === 'house-footprint-offset-x', error: fieldErrors['house-footprint-offset-x'], disabled: !showPlanContextControls, onCommit: (value) => commitFootprintEdit('house-footprint-offset-x', { type: 'param', key: 'offsetXM', value }) })}
    {renderField({ id: 'house-footprint-setback', kind: 'number', label: 'Facade setback (m)', value: footprintParams.setbackM, helperText: 'Visual house context only; pergola attachment stays fixed.', pending: pendingFieldId === 'house-footprint-setback', error: fieldErrors['house-footprint-setback'], disabled: !showPlanContextControls, onCommit: (value) => commitFootprintEdit('house-footprint-setback', { type: 'param', key: 'setbackM', value }) })}
