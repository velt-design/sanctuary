...
const COMPATIBLE_BASE_MANIFEST_UPGRADES: Record<string, readonly string[]> = {
  ...
  'v2.7': ['v2.8', 'v2.9'],
  'v2.6': ['v2.7', 'v2.8', 'v2.9'],
  'v1.7': ['v1.8', 'v1.9', 'v2.0', 'v2.1', 'v2.2', 'v2.3', 'v2.4', 'v2.5', 'v2.6', 'v2.7', 'v2.8', 'v2.9'],
  'v1.8': ['v1.9', 'v2.0', 'v2.1', 'v2.2', 'v2.3', 'v2.4', 'v2.5', 'v2.6', 'v2.7', 'v2.8', 'v2.9'],
  'v1.9': ['v2.0', 'v2.1', 'v2.2', 'v2.3', 'v2.4', 'v2.5', 'v2.6', 'v2.7', 'v2.8', 'v2.9'],
