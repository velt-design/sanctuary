...
export function InternalResidentialEmail(props: ResidentialOrCommercial & { callWindowText: string }) {
  ...
  return (
    <EmailLayout preview={`New lead - ${props.name} (${props.suburb})`}>
      ...
      <Text style={{ margin: 0, fontSize: 13, lineHeight: 1.6 }}>
        ...
        <br />
        - If no answer: send SMS + email to schedule
        <br />
        - Ask for photos + timing if not already provided
      </Text>
    </EmailLayout>
  );
}
