...
- `../xero-connection.md#next-stage-everyday-finance`: first business stage, current deposit proof, intended daily finance outcome and decisions still needed before expanding the pilot.
