...
export type RepresentativeRoofFinish = {
  ceiling?: 'cedar-100' | 'cedar-150' | 'thermopine-100' | 'thermopine-150';
...
export type RoofFinishMesh = { id: string; kind: 'steel' | 'cedar' | 'flashing'; positions: number[]; indices: number[]; timberSpecies?: 'cedar' | 'thermopine'; grainAcross?: Point3; grainAlong?: Point3 };
