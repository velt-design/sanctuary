...
export default defineConfig({
  testDir: './playwright',
  testMatch: /marketing\.(?:consent|contact|foundation|acrylic-foundation|acrylic-copy-variant|guide-cluster-final-refinement|guide-hub|hero-navigation|home-v2|mobile-content-density|phase-(?:three|four|five)|products|projects(?:-phase-two)?|seo-copy-hygiene|seo-landing|seo-programme|shared-header)\.spec\.ts/,
  timeout: 90_000,
