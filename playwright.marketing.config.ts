...
export default defineConfig({
  testDir: './playwright',
  testMatch: /marketing\.(?:foundation|acrylic-foundation|acrylic-copy-variant|guide-hub|hero-navigation|seo-copy-hygiene|seo-landing|seo-programme|shared-header)\.spec\.ts/,
  timeout: 90_000,
