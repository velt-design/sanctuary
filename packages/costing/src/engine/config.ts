...
import installActionsJson from '../config/install_actions_v1.7_2026-03-27.json';
import manifestJson from '../config/costing_manifest_v1.7_2026-03-27.json';
...
export const ACTIVE_COSTING_MANIFEST_PATH = 'packages/costing/src/config/costing_manifest_v1.7_2026-03-27.json' as const;
...
const EXPECTED_FILES = {
  ...
  install_actions: 'install_actions_v1.7_2026-03-27.json',
