...
- [`apps/portal/lib/drawings/README.md`](../apps/portal/lib/drawings/README.md)
- [`apps/portal/components/drawings/README.md`](../apps/portal/components/drawings/README.md)
...
```text
npm run test:portal -- apps/portal/lib/drawings/views/plan/houseFirstPlanOverlay.test.ts
