...
export const RUNNING_JOBS_COLUMNS: readonly RunningJobsColumnConfig[] = [
  ...
  { key: 'pergola_type', letter: 'G', label: 'Pergola type', widthPx: 188, kind: 'text', editable: false, source: 'estimate' },
  { key: 'estimated_start_date', letter: 'H', label: 'Estimated start', widthPx: 140, kind: 'date', editable: true, source: 'schedule' },
  { key: 'final_payment_date', letter: 'I', label: 'Final paid', widthPx: 128, kind: 'date', editable: true, source: 'manual' },
  { key: 'job_assigned_to', letter: 'J', label: 'Crew', widthPx: 104, kind: 'text', editable: true, source: 'schedule' },
  { key: 'job_completed', letter: 'K', label: 'Completed', widthPx: 112, kind: 'boolean', editable: true, source: 'schedule' },
  { key: 'lights_status', letter: 'L', label: 'Lights', widthPx: 96, kind: 'status', editable: true, source: 'manual' },
  { key: 'blinds_status', letter: 'M', label: 'Blinds', widthPx: 96, kind: 'status', editable: false, source: 'estimate' },
  { key: 'install_days', letter: 'N', label: 'Install days', widthPx: 112, kind: 'number', editable: true, source: 'schedule' },
  { key: 'size_text', letter: 'O', label: 'Size', widthPx: 156, kind: 'text', editable: false, source: 'estimate' },
  { key: 'colour_text', letter: 'P', label: 'Colour', widthPx: 150, kind: 'text', editable: false, source: 'estimate' },
  { key: 'roofing_text', letter: 'Q', label: 'Roofing', widthPx: 180, kind: 'text', editable: false, source: 'estimate' },
