...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: 'portal-fixture',
      testMatch: /portal\.(command-centre|drawing-workbench|email-preview-workbench|workbench-snapshot|workbench-fixture|workbench-performance|project-mutation-performance)\.spec\.ts/,
      use: {
        ...devices['Desktop Chrome'],
