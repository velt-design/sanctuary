...
/**
 * Aggregate simple project reference shapes. Pergola references feed snap and
 * fallback context; house references are canonical committed house targets.
 */
