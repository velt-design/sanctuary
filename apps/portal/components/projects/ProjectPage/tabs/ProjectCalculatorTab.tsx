...
export default function ProjectCalculatorTab({
  ...
  const workspace = useMemo<CalculatorProjectWorkspace>(() => ({
    ...
    newEstimateCommercialScopeId: revisionSource?.commercialScopeId ?? selectedEstimate?.commercialScopeId ?? requestedCommercialScopeId,
    newEstimateCommercialScopeKind: revisionSource?.commercialScopeKind ?? selectedEstimate?.commercialScopeKind ?? requestedEstimateKind,
    designNavigation,
    onEstimateSaved,
    onOpenProject,
