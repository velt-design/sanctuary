...
| 2026-06-03 | Workbench House Forms            | Active   | Multi-house house-form status must validate roof intent against that form's resolved geometry input, not an empty preset draft polygon or first-house fallback.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
