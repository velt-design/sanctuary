...
- The existing Overview conditionally renders the V2 work command card/sidebar without changing the approved portal visual system. Blocked work is an exception rather than an enabled primary action.
