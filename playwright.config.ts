...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      name: 'portal-fixture',
      testMatch:
        /portal\.(command-centre|commercial-workflow-fixture|design-booklet-workbench|drawing-workbench|email-preview-workbench|invoice-artifact-preview-fixture|project-work-queue-fixture|workbench-snapshot|workbench-fixture|workbench-performance|project-mutation-performance)\.spec\.ts/,
      use: {
        ...devices['Desktop Chrome'],
