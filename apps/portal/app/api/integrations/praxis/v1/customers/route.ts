import { parseCustomerSearch, searchPraxisCustomers } from '../../../../../../lib/praxis/customer-read';
...
export async function GET(request: Request): Promise<Response> {
  ...
  try {
    ...
    const result = await searchPraxisCustomers(parseCustomerSearch(new URL(request.url)), config, requestId);
