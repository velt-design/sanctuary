...
- Next direction: JOB-01 remains foundation-only until its five migrations execute successfully across the isolated real-PGMQ CI matrix and deployment readiness is reviewed. JOB-02 through JOB-08 are still pending; none should be inferred from the shared registry or migration names.
