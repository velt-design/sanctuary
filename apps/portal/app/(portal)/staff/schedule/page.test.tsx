...
describe('StaffSchedulePage', () => {
  ...
  it('keeps the site visits entrypoint independent from Board and Gantt modules', () => {
    const source = readFileSync(path.join(process.cwd(), 'apps/portal/app/(portal)/staff/schedule/SiteVisitsScheduleClient.tsx'), 'utf8');
  ...
  it('keeps Gantt axis code behind the Gantt view boundary', () => {
    const scheduleClient = readFileSync(path.join(process.cwd(), 'apps/portal/app/(portal)/staff/schedule/ScheduleClient.tsx'), 'utf8');
    const ganttView = readFileSync(path.join(process.cwd(), 'apps/portal/app/(portal)/staff/schedule/ScheduleGanttView.tsx'), 'utf8');
  ...
  it('keeps Board drag code behind the Board view boundary', () => {
    const scheduleClient = readFileSync(path.join(process.cwd(), 'apps/portal/app/(portal)/staff/schedule/ScheduleClient.tsx'), 'utf8');
    const boardView = readFileSync(path.join(process.cwd(), 'apps/portal/app/(portal)/staff/schedule/ScheduleBoardView.tsx'), 'utf8');
    const ganttView = readFileSync(path.join(process.cwd(), 'apps/portal/app/(portal)/staff/schedule/ScheduleGanttView.tsx'), 'utf8');
  ...
  it('keeps legacy schedule repos behind the legacy fallback boundary', () => {
    const scheduleClient = readFileSync(path.join(process.cwd(), 'apps/portal/app/(portal)/staff/schedule/ScheduleClient.tsx'), 'utf8');
    const legacyClient = readFileSync(path.join(process.cwd(), 'apps/portal/app/(portal)/staff/schedule/ScheduleLegacyFallbackClient.tsx'), 'utf8');
  ...
  it('keeps V2 and legacy board model dependencies separated', () => {
    const v2Model = readFileSync(path.join(process.cwd(), 'apps/portal/app/(portal)/staff/schedule/ScheduleBoardModelV2.ts'), 'utf8');
    const legacyModel = readFileSync(path.join(process.cwd(), 'apps/portal/app/(portal)/staff/schedule/ScheduleBoardModelLegacy.ts'), 'utf8');
  ...
  it('keeps schedule CSS imports scoped by view boundary', () => {
    const scheduleDir = path.join(process.cwd(), 'apps/portal/app/(portal)/staff/schedule');
  ...
  it('keeps shared schedule CSS free of view-owned selectors', () => {
    const sharedCss = readFileSync(path.join(process.cwd(), 'apps/portal/app/(portal)/staff/schedule/schedule.module.css'), 'utf8');
