...
export default defineConfig({
  testDir: './playwright',
  testMatch: /marketing\.(?:consent|contact|foundation|acrylic-foundation|acrylic-copy-variant|guide-cluster-final-refinement|guide-hub|hero-navigation|home-v2|products|projects|seo-copy-hygiene|seo-landing|seo-programme|shared-header)\.spec\.ts/,
  timeout: 90_000,
