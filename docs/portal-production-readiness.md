...
This snapshot records the most recent known production-readiness state from the portal review and follow-up checks. The current repository ref remains `005be1a7`; the uncommitted 2026-07-28 commercial-trust slice below has current local test, typecheck, lint, isolated build, security, architecture, deterministic browser-fixture, and rendered-PDF evidence. Its forward database migration and real provider/public-token journeys have not been executed.
...
| ----------------------------------- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Portal tests | Green | On 2026-07-28 the local commercial-trust worktree passed 403 portal Vitest files with 2,155 tests plus 11 intentional skips, the full 53-file/286-test marketing suite, focused commercial/route/fixture contracts, repository typecheck and lint. The gated commercial recovery fixture was also inspected through the production components without provider or database access. | Keep the broad repository gates blocking and execute the forward migration contract plus deliberate staging side-effect journeys before release. |
...
| UI foundation hardening | Green | The catalogue, responsive shell, canonical status contracts, focus-managed modal/drawer, production workflow patterns, reduced-motion and contrast rules, focused component coverage, and narrow Projects Index/Detail proof are implemented. Full portal tests, an isolated fresh production build, all six existing route bundle ceilings, and the dedicated 1440/1280/1024/768/390 plus 200% zoom production Playwright re-audit are green. | Keep rollout limited to the two proof routes; any wider portal migration requires separate approval and route-specific proof. |
...
| Security and data boundaries | Yellow | The 2026-07-28 commercial-trust worktree passes the audit, service-role inventory, browser-Supabase inventory, static migration contract, route tests, public-token tests, and deterministic provider-adapter tests. New commercial helpers are server-only service-role owners for private frozen intents, replay-safe finalisation, and audit writes; the public RPC grants remain narrow and token/customer content stays out of logs and browser props. | Apply `20260728_000001_commercial_workflow_trust.sql` only through the normal reviewed migration path, run it against a disposable compatible database first, then complete authenticated/public-token staging QA without using production data. |
...
| Quote/invoice/job-pack side effects | Green | The 2026-07-28 Option B worktree adds exact estimate/quote intents, monotonic quote revisions, one current draft, atomic delivery preparation, private frozen email intents, provider checkpoints, replay-safe finalisation, atomic acceptance/invoice identity, truthful recovery UI, deterministic retry/attention fixtures, and rendered quote-PDF pagination coverage. The connected pre-migration environment exposed a missing recovery RPC; quote detail now degrades to explicit read-only review instead of `500`, while delivery/recovery routes fail closed with `503 COMMERCIAL_WORKFLOW_SCHEMA_NOT_READY`. No real provider call, migration, or production write was made. | Execute the migration in a disposable compatible environment, then perform deliberate staging send/resend/public acceptance/invoice-delivery checks with controlled recipients before release. |
