...
Earlier choices retain clean product views. MobileDesignPortrait and optional Explore request the richer review setting: reference paving, recessed glazing, wall finish and full-size furniture. The illustration is labelled, unpriced and excluded from saved design intent. Paving follows attached terrace geometry. Foreground foliage fades when it obstructs the product. Review portraits fit the whole product; Explore starts at fitted distance divided by1.2 and allows user zoom/orbit. Contact cues and fabric/stone/glazing detail are procedural.

StudioFurnitureLayout chooses a full angular L lounge with separate chair, concrete dining table with upholstered curved-back chairs, or both where space permits. The lounge fit zone is3400x2700mm; dining2900x2700mm. Shallow layouts use a1700mm two-seat sofa and800x450mm coffee table, optionally with a lounge chair (3500x1800mm zone), or alone (2400x1700mm zone). A650mm square bistro table and two chairs use a1700x1600mm zone. Rear access margins, post exclusion and between-setting space apply. These are illustrative placement rules, not certified access dimensions. Furniture is omitted when it cannot fit, never scaled down.
