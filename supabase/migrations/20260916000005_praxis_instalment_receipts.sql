-- Approved instalments are linked to their invoice by xero_deposit_matches.
-- source_invoice_id is optional legacy whole-invoice provenance; a conflicting
-- non-null value remains invalid. An unmatched project payment is never verified.
...
begin;
create or replace view praxis_reporting.verified_receipts_v1
...
join public.project_payment_entries entry
  ...
  and (entry.source_invoice_id is null or entry.source_invoice_id = match.invoice_id)
