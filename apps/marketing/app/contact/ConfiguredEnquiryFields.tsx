...
export default function ConfiguredEnquiryFields({onSubmit,onInteraction,errors,state,error,receivedEarlier=false,mobileFinish=false}:{onSubmit:FormEventHandler<HTMLFormElement>;onInteraction?:()=>void;errors:ContactFieldErrors;state:string;error:string|null;receivedEarlier?:boolean;mobileFinish?:boolean}){
 ...
 return <form data-clarity-mask="true" className={css.form} ref={form} onInput={save} onInputCapture={onInteraction} onChangeCapture={onInteraction} onSubmit={onSubmit} noValidate>
