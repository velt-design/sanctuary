...
- PR-AI-005, exact expiring single-use synthetic approval envelopes: active. It adds no model/provider call, worker handler, external effect, or production deployment.
