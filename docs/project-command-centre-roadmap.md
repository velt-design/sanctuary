...
| Performance target | NOT MET. Saved receiver read remains1.36–2.88s before matching/finalchecks. Current total saved journeys about5–7s. No passing overall outcome/handover rating. |
...
| Release | Portal draft PR153; new Velt placement draft PR380. No production performance changes. Goal remains active. |
