...
| `footprintMath.ts` | Footprint polygon utilities: `isOrthogonalFootprint`, legacy adjacent-edge `offsetFootprintPolygon`, `clearanceToPolygon`, `findInteriorRoofNode`, `polygonLineInterval`, `closestPointOnLineSegment2D`, `isRectanglePolygon`. | ✅ shipped |
