import { parseReceiptProject, readPraxisVerifiedReceipts } from '../../../../../../lib/praxis/customer-read';
...
export async function GET(request: Request): Promise<Response> {
  ...
  try {
    ...
    const result = await readPraxisVerifiedReceipts(parseReceiptProject(new URL(request.url)), config, requestId);
