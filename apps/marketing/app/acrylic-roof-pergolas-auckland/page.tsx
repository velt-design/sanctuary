    ...
    <main className="acrylic-landing" data-marketing-foundation-page>
      ...
      <section className="acrylic-hero" aria-labelledby="acrylic-hero-title">
        ...
        <Container width="wide" className="acrylic-hero__content">
          <Eyebrow className="acrylic-eyebrow">Custom acrylic pergolas for Auckland homes</Eyebrow>
          <Heading as="h1" variant="page" id="acrylic-hero-title">Acrylic roof pergolas for Auckland homes, designed to keep the light</Heading>
          ...
          <div className="acrylic-hero__actions">
            <Button href="#estimate">Request an initial estimate</Button>
            <TextLink href="#acrylic-options">Compare acrylic roof options</TextLink>
          </div>
      ...
      <Section className="acrylic-section acrylic-section--opening" aria-labelledby="cover-without-closing">
        <Container width="wide" className="acrylic-intro-grid">
          <div>
            <Eyebrow className="acrylic-eyebrow">Light, shelter and the house</Eyebrow>
            <Heading id="cover-without-closing">Cover the space without closing it in</Heading>
          </div>
      ...
      <Section className="acrylic-section" aria-labelledby="why-acrylic">
        <Container width="wide">
          <header className="acrylic-section__header">
            <Eyebrow className="acrylic-eyebrow">Material-led design</Eyebrow>
            <Heading id="why-acrylic">Why choose an acrylic roof?</Heading>
          </header>
      ...
      <Section id="acrylic-options" tone="warm" className="acrylic-section acrylic-section--tints" aria-labelledby="compare-tints">
        <Container width="wide">
          <header className="acrylic-section__header acrylic-section__header--wide">
            <Eyebrow className="acrylic-eyebrow">Compare the visual effect</Eyebrow>
            <Heading id="compare-tints">Clear, light grey, dark grey or opal acrylic?</Heading>
            <Text size="large">There is no universally correct acrylic tint. The most appropriate option depends on the direction of the sun, roof area, pergola depth, nearby glazing, surrounding surfaces and how much daylight the adjoining rooms can afford to lose.</Text>
          </header>
          ...
          <aside className="acrylic-callout" aria-labelledby="choose-for-site">
            <Eyebrow className="acrylic-eyebrow">The whole roof changes the result</Eyebrow>
      ...
      <Section className="acrylic-section" aria-labelledby="summer-comfort">
        <Container width="wide" className="acrylic-editorial-grid">
          ...
          <div>
            ...
            <Heading id="summer-comfort">Will it get too hot under an acrylic pergola?</Heading>
      ...
      <Section tone="inverse" className="acrylic-section acrylic-section--dark" aria-labelledby="weather-details">
        <Container width="wide">
          <div className="acrylic-section__header acrylic-section__header--wide">
            <Eyebrow className="acrylic-eyebrow">Rain, drainage and house integration</Eyebrow>
            <Heading id="weather-details">Weather protection starts with the roof details</Heading>
      ...
      <Section className="acrylic-section" aria-labelledby="pergola-forms">
        <Container width="wide">
          <header className="acrylic-section__header">
            <Eyebrow className="acrylic-eyebrow">Pergola design options</Eyebrow>
            <Heading id="pergola-forms">Acrylic roofing across different pergola forms</Heading>
          </header>
      ...
      <Section tone="neutral" className="acrylic-section acrylic-section--why" aria-labelledby="one-system">
        <Container width="wide" className="acrylic-intro-grid">
          <div>
            <Eyebrow className="acrylic-eyebrow">Why Sanctuary</Eyebrow>
            <Heading id="one-system">Designed as one architectural system</Heading>
      ...
      <Section className="acrylic-section" aria-labelledby="completed-projects">
        <Container width="wide">
          <header className="acrylic-section__header acrylic-section__header--wide">
            <Eyebrow className="acrylic-eyebrow">Verified Sanctuary projects</Eyebrow>
            <Heading id="completed-projects">See how acrylic choices work in completed projects</Heading>
          ...
          <div className="acrylic-section__action"><Button href="/projects" variant="outline">View all completed projects</Button></div>
        </Container>
      </Section>
      ...
      <Section tone="neutral" className="acrylic-section acrylic-section--consent" aria-labelledby="consent-engineering">
        <Container width="wide" className="acrylic-intro-grid">
          <div>
            <Eyebrow className="acrylic-eyebrow">Site-specific assessment</Eyebrow>
            <Heading id="consent-engineering">Consent and engineering depend on the final design</Heading>
          </div>
          <div className="acrylic-prose">
      ...
      <Section tone="elevated" className="acrylic-section acrylic-section--faq" aria-labelledby="acrylic-faq">
        <Container width="wide">
          <header className="acrylic-section__header">
            <Eyebrow className="acrylic-eyebrow">Frequently asked questions</Eyebrow>
      ...
      <Section tone="inverse" className="acrylic-section acrylic-section--final-cta" aria-labelledby="request-estimate">
        <Container width="wide" className="acrylic-final-grid">
          <div>
            <Eyebrow className="acrylic-eyebrow">Your project, in context</Eyebrow>
            <Heading id="request-estimate">Request an initial estimate for your acrylic pergola</Heading>
