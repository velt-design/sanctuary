...
describe("house model roof preset coverage", () => {
  ...
  it("canonicalizes edited custom hipped footprint residue before roof topology solve", () => {
    const footprint: Polygon3 = [
      ...
      { x: 2399.9999995950566, y: 1200.0000001296671, z: 0 },
      { x: 2399.9999995950566, y: 0.00000012966711437911727, z: 0 },
      { x: 8901.820743595055, y: 0.00000012966711437911727, z: 0 },
      { x: 8901.820743595055, y: 4171.359789141505, z: 0 },
