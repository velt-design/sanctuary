...
import installActionsJson from '../config/install_actions_v1.5_2026-01-09.json';
import manifestJson from '../config/costing_manifest_v1.5_2026-01-09.json';
...
export const ACTIVE_COSTING_MANIFEST_PATH = 'src/costing/config/costing_manifest_v1.5_2026-01-09.json' as const;
...
const EXPECTED_FILES = {
  ...
  install_actions: 'install_actions_v1.5_2026-01-09.json',
  ...
  if (mismatches.length) {
    throw new Error(
      [
        ...
        ...mismatches,
        'Update imports in src/costing/engine/config.ts to include the new versioned JSONs.',
      ].join('\n'),
    );
  }
