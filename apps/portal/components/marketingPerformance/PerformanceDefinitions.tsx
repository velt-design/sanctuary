  ...
  return <Card title="How to read this report" padding="compact">
    ...
    <details><summary>Definitions, denominators and historical limits</summary>
      <dl className={styles.definitions}>
        <dt>Enquiry cohort</dt><dd>One saved enquiry ID received in the date range. Retried submissions reuse their ID. Separate submissions remain separate enquiries; this is not a unique-person count. Manual projects without an enquiry receipt are outside this report.</dd>
        ...
        <dt>Won projects</dt><dd>At least one unreversed verified Xero payment match, or a paid first-instalment invoice on current accepted scope. Matches can be partial deposits. A pipeline stage or accepted quote alone does not prove a win. Reversals can reduce current totals.</dd>
        <dt>Money and platform claims</dt><dd>Quoted value, accepted value and money received are different facts. This version reports outcome counts, not revenue. Google and Meta claimed conversions and customer-reported discovery are not connected and are never added to verified totals.</dd>
