...
create or replace function public.marketing_enquiry_staff_receipts(p_project_id uuid)
...
begin
  ...
  return coalesce((select jsonb_agg(jsonb_build_object(
    ...
    'emailStatus', o.status, 'deliveryStatus', j.status
  ...
  left join public.background_jobs j on j.id = d.job_id
