...
export const metadata: Metadata = {
  title: { absolute: 'Gable Pergolas Auckland | Custom Design & Installation' }, description: gablePergolasConfig.description, alternates: { canonical: gablePergolasConfig.route },
  ...
  twitter: { card: 'summary_large_image', title: 'Gable Pergolas Designed in Section, Not Chosen by Silhouette', description: 'A practical guide to the proportions and decisions behind a custom gable pergola.', images: [gablePergolasConfig.hero.image] },
};
