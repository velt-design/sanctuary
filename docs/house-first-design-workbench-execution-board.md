...
- The compatibility House Forms inspector now treats all existing footprint presets and flat, mono, gable, and hipped house roof forms as live hidden-route editing controls, with all eight preset footprints expected to preview without blocking roof topology diagnostics across attachment-side rotations.
- Preset changes preserve roof-form intent while re-solving stale gable/hipped ridge orientation and open-gable end ids against the rebuilt footprint.
