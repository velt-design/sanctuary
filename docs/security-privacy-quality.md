...
| Google Analytics GA4 | analytics | GTM via `apps/marketing/components/GoogleTagManager.tsx`; Web Vitals originate in `apps/marketing/components/WebVitals.tsx` | Page and Web Vitals analytics | Marketing and Engineering |
