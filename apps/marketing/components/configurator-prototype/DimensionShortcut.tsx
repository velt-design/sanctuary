...
export default function DimensionShortcut({axis,value}:{axis:'width'|'projection';value:number}){
 ...
 function focusSlider(){const slider=document.querySelector<HTMLInputElement>(`[data-dimension="${axis}"] input[inputmode="decimal"]`);slider?.scrollIntoView({block:'center'});slider?.focus({preventScroll:true});}
