...
export const RUNNING_JOBS_COLUMNS: readonly RunningJobsColumnConfig[] = [
  ...
  { key: 'deposit_paid_date', letter: 'E', label: 'Deposit paid', widthPx: 136, kind: 'date', editable: true, source: 'manual', sourceLabel: 'Invoices' },
  ...
  { key: 'final_payment_date', letter: 'I', label: 'Final paid', widthPx: 128, kind: 'date', editable: true, source: 'manual', sourceLabel: 'Invoices' },
