...
export const portalRouteCatalog = [
  ...
  },
  {
    ...
    smokeStatus: 'catalog-only',
    debugExportStatus: 'not-applicable',
    notes: 'Authenticated one-row-per-project operational queue; its read-model readiness belongs to the focused Project Work gate.',
  },
  {
    ...
    smokeStatus: 'fixture-only',
    debugExportStatus: 'not-applicable',
    notes: 'Synthetic prepared-delivery recovery fixture gated by ENABLE_PORTAL_QA_FIXTURES; it dispatches no provider request.',
  },
  {
    ...
    requiredRole: 'fixture',
    ownerDoc: 'docs/quotes-invoices-job-packs.md',
    expectedHeading: 'Invoice artifact preview fixture',
    expectedShell: 'fixture-shell',
    dataRequirement: 'fixture_flag',
    smokeStatus: 'fixture-only',
    debugExportStatus: 'not-applicable',
    notes: 'Customer-data-free invoice artifact preview gated by ENABLE_PORTAL_QA_FIXTURES.',
  },
  {
    ...
    smokeStatus: 'fixture-only',
    debugExportStatus: 'not-applicable',
    notes: 'Synthetic Project Work queue fixture gated by ENABLE_PORTAL_QA_FIXTURES.',
  },
  {
    ...
    requiredRole: 'fixture',
    ownerDoc: 'docs/schedule.md',
    expectedHeading: 'Schedule operational context',
    expectedShell: 'fixture-shell',
    dataRequirement: 'fixture_flag',
    smokeStatus: 'fixture-only',
    debugExportStatus: 'not-applicable',
    notes: 'Synthetic Board/Gantt operations fixture gated by ENABLE_PORTAL_QA_FIXTURES; controls cannot persist changes.',
  },
  {
    id: 'qa-ai-activity-fixture',
    category: 'diagnostic',
    routePattern: '/qa/ai-activity-fixture',
    requiredRole: 'fixture',
    ownerDoc: 'docs/ai/README.md',
    expectedHeading: 'AI Activity',
    expectedShell: 'fixture-shell',
    dataRequirement: 'fixture_flag',
    smokeStatus: 'fixture-only',
    debugExportStatus: 'not-applicable',
    notes: 'Synthetic-only read model fixture gated by ENABLE_PORTAL_QA_FIXTURES; it performs no Supabase read, task execution, or effect.',
  },
  {
