...
| Project Operational Command Centre behavior, stage, read model, or Overview changes | `docs/project-command-centre-v1.md`, `docs/project-command-centre-architecture.md`, and `docs/project-command-centre-roadmap.md` | `docs/projects-contacts-estimates-calculator.md`, `docs/portal-ux-roadmap.md`, `docs/portal-production-readiness.md` | Command-centre domain/API/UI tests, fixture browser matrix, project tests, bundle gate, and authenticated smoke/performance when available. |
...
| Standalone marketing foundation primitives, editorial patterns, or hidden catalogue changes | `docs/marketing-ui-foundation.md` | `docs/security-privacy-quality.md` only when tracking, consent, or public conversion behavior also changes | Marketing typecheck, focused tests, browser responsive/accessibility matrix, build, visual review, and public-source parity check. |
...
| `apps/portal/lib/projects/commandCentre/**`, `apps/portal/app/api/staff/v1/projects/**/command-centre/**`, `apps/portal/components/projects/ProjectPage/tabs/OverviewTab.tsx`, `apps/portal/components/projects/ProjectPage/tabs/overview/**`, `apps/portal/app/qa/project-command-centre-fixture/**`, `playwright/portal.command-centre.spec.ts` | `docs/project-command-centre-v1.md`, `docs/project-command-centre-architecture.md`, `docs/project-command-centre-roadmap.md` | Preserve the internal `activity` key, exact quote source/price rules, auth-bound read model, truthful states, specialist ownership, and unchanged performance budgets. |
| `apps/portal/components/ui/foundation/**`, `apps/portal/components/layout/PageHeader*`, `apps/portal/app/staff/ui-foundation/**` | `docs/ui-foundation.md` | Keep the catalogue built from production-ready exports, preserve explicit dashboard/index/detail title hierarchy, and avoid migrating production screens implicitly. |
...
| `apps/marketing/components/marketing-foundation/**`, `apps/marketing/app/%5F%5Ffoundation/**`, `playwright/marketing.foundation.spec.ts` | `docs/marketing-ui-foundation.md` | Keep the catalogue isolated from public marketing routes and built from reusable exports; any public-route migration requires separate explicit approval. |
