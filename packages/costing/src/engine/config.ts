...
import manifestJson from '../config/costing_manifest_v2.2_2026-08-05.json';
...
import commercialPolicyJson from '../config/commercial_policy_v4_2026-08-05.json';
...
export const ACTIVE_COSTING_MANIFEST_PATH = 'packages/costing/src/config/costing_manifest_v2.2_2026-08-05.json' as const;
...
export type CommercialPolicyV4 = typeof commercialPolicyJson;
...
export type CostingConfigV1 = {
  ...
  commercialPolicy: CommercialPolicyV4;
...
const EXPECTED_FILES = {
  ...
  install_actions: 'install_actions_v1.8_2026-07-28.json',
  ...
  commercial_policy: 'commercial_policy_v4_2026-08-05.json',
} as const;
