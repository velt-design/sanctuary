...
- the staff-wide Work Queue and Dashboard preview consume one server-composed current row per project, and the full queue is paged without truncating the portfolio;
