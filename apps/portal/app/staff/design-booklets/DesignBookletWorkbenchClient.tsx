...
export default function DesignBookletWorkbenchClient({
  ...
  return (
    ...
    >
      ...
      <div className={styles.viewportLayout} data-booklet-viewport>
        <aside
          className={styles.controlPanel}
          aria-label="Booklet controls"
          data-booklet-control-panel
        >
          <section className={styles.intro}>
            <div>
              <p className={styles.sectionEyebrow}>Design booklet workbench</p>
              <h1>Build the booklet around the design.</h1>
            </div>
            <div className={styles.introAside}>
              <p>
                Choose the image and drawing pages, arrange the sequence, and
                review the same landscape story your customer will receive.
              </p>
          ...
          <section
            ...
            id="booklet-details"
            aria-label="Booklet details"
          >
            <header className={styles.sectionHeader}>
              <div className={styles.sectionNumber}>01</div>
              <div>
                <p className={styles.sectionEyebrow}>Booklet details</p>
                <h2>Set the cover story.</h2>
              </div>
              <p>
                Everything stays in this browser until the PDF is downloaded.
              </p>
            </header>
            ...
            <p className={styles.sourceNote}>
              Roof-form and material labels come from the governed marketing
              content. No product claims are added to the booklet.
            </p>
          </section>

          <section className={styles.pagesSection} id="booklet-pages">
            <header className={styles.sectionHeader}>
              <div className={styles.sectionNumber}>02</div>
              <div>
                <p className={styles.sectionEyebrow}>Booklet pages</p>
                <h2>Choose and arrange the story.</h2>
              </div>
              <p>
                The cover and review page stay fixed. Every page between them
                can be added, removed or reordered.
              </p>
            </header>
        ...
        <section
          ...
          data-booklet-preview-workspace
        >
          <header className={styles.sectionHeader}>
            <div className={styles.sectionNumber}>03</div>
            <div>
              <p className={styles.sectionEyebrow}>Customer preview</p>
              <h2>Move through the booklet.</h2>
            </div>
          ...
          <nav className={styles.pageRail} aria-label="Booklet pages">
            {pageModel.map((page) => (
              <button
                type="button"
                key={page.key}
                aria-current={selectedPageKey === page.key ? "page" : undefined}
