...
const mocks = vi.hoisted(() => ({ session: vi.fn(), origin: vi.fn(), review: vi.fn(), approve: vi.fn(), match: vi.fn() }));
...
vi.mock('@/lib/invoices/xeroMatchRepository', () => ({ findPilotMatch: mocks.match }));
