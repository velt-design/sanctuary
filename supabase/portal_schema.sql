...
create unique index if not exists job_pack_generations_quote_version_id_key on public.job_pack_generations(quote_version_id);
create index if not exists job_pack_generations_project_id_idx on public.job_pack_generations(project_id, created_at desc);
create index if not exists job_pack_generations_estimate_id_idx on public.job_pack_generations(estimate_id, created_at desc);
