...
function buildRoofPlanes(takeoff: GeometryQuantityTakeoff | null): NonNullable<CommercialQuantityTakeoffV1['roofPlanes']> {
  return (takeoff?.roofPlanes.items ?? []).map((plane, index) => ({
    ...
    label: plane.label,
    areaM2: plane.areaM2,
    rafterProjectedRunM: plane.rafterProjectedRunM,
    rafterCutLengthM: plane.rafterCutLengthM,
    ...
    claddingDownslopeLengthM: plane.claddingDownslopeLengthM,
    claddingPanelCount: plane.claddingPanelCount,
    joinerCount: plane.joinerCount,
    joinerTargetLengthM: plane.joinerTargetLengthM,
...
function buildQuantityTakeoff(module: WorkbenchSolvedModule): CommercialQuantityTakeoffV1 {
  ...
  return {
    ...
    rafters: {
      ...
      effectiveRunM: takeoff?.rafters.effectiveRunM ?? null,
      projectedRunM: takeoff?.rafters.averageProjectedRunM ?? null,
    ...
    roofCladding: {
      ...
      timberAreaM2: null,
      sheetCount: null,
      effectiveRunM: takeoff?.roofCladding.effectiveRunM ?? null,
      acrylicRequiredDownslopeM: takeoff?.roofCladding.acrylicRequiredDownslopeM ?? null,
      averageDownslopeLengthM: takeoff?.roofCladding.averageDownslopeLengthM ?? null,
